...
\033[1;32m[-] AUTHOR    :\033[1;32m MD JOSIM UDDIN 
\033[1;32m[-] GITHUB    :\033[1;32m mdjosimuddin198
\033[1;32m[-] FACEBOOK  :\033[1;32m MD JOSIM UDDIN
...
rp= 'JOSIM'
x = '19'
if 'JOSIM'==user and '19'==pas:
	Axak(g+"\n\n\t\t      LOGIN SUCCESSFUL JOIN ME ON FACEBOOK  ")
	os.system('xdg-open https://www.facebook.com/mdjosimuddin198/?mibextid=ZbWKwL')
else:
	Axak(y+"\n\n\t\t      Invalid User Or Pass")
	Axak(y+"\n\n\t\tContract Admin For User And Pass")
	os.system("xdg-open https://wa.me/+8801725508545")
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH JOSIMUDDIN198 ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥MDJOSIMUDDIN198🔥 "+w+tim)
